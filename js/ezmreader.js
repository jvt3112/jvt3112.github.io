...
/* var scriptTag = "<script src=\"/js/ezmreader.js\""+ "><\/script>";
$("#zineframe").contents().find("body").append(scriptTag);
$("#zineframe").attr(
    ...
    "<script id=\"zine\" base-url=\"{{ .Get \"base-url\" }}\" src=\"/js/ezmreader.js\"><" +  "/script>" +
    "</html>"
 ); */
...
let textures = [];
let pages = [];
// const neww =width.innerWidth*0.3; const newh = width.innerHeight*0.3; 
// window.resizeTo(width: neww, height: newh);
// window.resizeTo(neww, newh);
// window.resizeTo(100,100);

document.getElementById("zinediv").style.background=BGCOLOR;
document.getElementById("zinediv").ariaLabel=ALT;

// document.body.style.background = BGCOLOR;
// document.body.ariaLabel = ALT;
if (SMOOTH) {
    document.getElementById("zinediv").imageRendering='auto';
    // document.body.style.imageRendering = 'auto';
} else {
    document.getElementById("zinediv").imageRendering = 'pixelated';
...
var name_val = document.getElementById("zine").getAttribute("base-url");
...
Promise.all(
    ...
    .then(imgs => {
        ...
        document.getElementById("zinediv").appendChild(list);
        // document.getElementById("zinediv").append("<div id=\"clr\" style=\"clear:both;font-size:0;\"></div>");
